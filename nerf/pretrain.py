...
from nerf.pretrainer import PreTrainer
...
def train(cfg : DictConfig) -> None:
    ...
    sparse_points_pcd = o3d.io.read_point_cloud("/home/casey/Uni/data/plant_and_food/tonemapped/2022-08-31/jpeg_north/refined_5cm.pcd")
    sparse_points = torch.Tensor(np.asarray(sparse_points_pcd.points)).to('cuda')
